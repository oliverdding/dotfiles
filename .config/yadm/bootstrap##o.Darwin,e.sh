...
# configure host name
sudo scutil --set ComputerName "$DOT_HOSTNAME"
sudo scutil --set HostName "$DOT_HOSTNAME"
sudo scutil --set LocalHostName "$DOT_HOSTNAME"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "$DOT_HOSTNAME"
...
defaults write NSGlobalDomain AppleLocale -string "en-CN"
